...
public class UCropActivity extends AppCompatActivity {
    ...
    private void processOptions(@NonNull Intent intent) {
        ...
        mOverlayView.setCropRectMinSize(intent.getIntExtra(UCrop.Options.EXTRA_CROP_RECT_MIN_SIZE, getResources().getDimensionPixelSize(R.dimen.ucrop_default_crop_rect_min_size)));
